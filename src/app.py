...
activities = {
    "Chess Club": {
        "description": "Strategic board game with competitive matches",
        ...
        "Basketball Team": {
        "description": "Basketball drills and interschool games",
        ...
        "Debate Team": {
        "description": "Formal debate practice and tournaments",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Add student
    # Validate studen is not already signed up
